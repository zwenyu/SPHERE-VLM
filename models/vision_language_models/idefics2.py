"""
Idefics2: https://huggingface.co/HuggingFaceM4/idefics2-8b, https://huggingface.co/blog/idefics2
"""
...
class Idefics2(VisionLanguageModel):
    def __init__(self, device="cuda", load=True):
        self.device = device
        self.model_name = "idefics2"
    ...
    def predict(self, image, image_path, text):
        ...
        text_response = text_output[len(prompt)-24:].strip() # remove tag characters
